...
public class BookController {
  ...
  @GetMapping("/booklist")
  public String getAllBooks(@ModelAttribute("parameter") String parameter, @ModelAttribute("value") String value,
      Model model) {
  ...
  public String searchBooks(@RequestParam(name = "argument", required = false) String parameter,
      @RequestParam(name = "argumentValue", required = false) String value, RedirectAttributes redirectAttributes) {
  ...
  @PostMapping("/addbook")
  public String addBook(@ModelAttribute @Valid Book book, BindingResult bindResult,
